...
/**
 * CatSucursalesSearch represents the model behind the search form about `app\models\CatSucursales`.
 */
class CatSucursalesSearch extends CatSucursales
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_sucursal', 'b_habilitado'], 'integer'],
