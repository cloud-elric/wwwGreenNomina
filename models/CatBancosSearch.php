...
/**
 * CatBancosSearch represents the model behind the search form about `app\models\CatBancos`.
 */
class CatBancosSearch extends CatBancos
{
    /**
     * @inheritdoc
     */
